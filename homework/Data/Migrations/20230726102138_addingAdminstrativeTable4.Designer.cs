...
namespace homework.Data.Migrations
{
    ...
    [Migration("20230726102138_addingAdminstrativeTable4")]
    partial class addingAdminstrativeTable4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("homework.Model.MainClass.EmployeModel", b =>
                {
                    ...
                    b.Property<int>("departmentTabelId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("departmentTabelId");
            ...
            modelBuilder.Entity("homework.Model.MainClass.EmployeModel", b =>
                {
                    b.HasOne("homework.Model.MainClass.DepartmentModel", "departmentTabel")
                        .WithMany()
                        .HasForeignKey("departmentTabelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("departmentTabel");
                });
